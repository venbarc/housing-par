                    ...
                    >
                        <div className="flex items-center justify-between px-5 pt-5 pb-3">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h2 className="font-semibold text-slate-900">Bed {bed.bed_number}</h2>
                                    <p className="text-xs text-slate-500">Ward {bed.ward_id} &bull; Room {bed.room}</p>
                                </div>
                            </div>
                            ...
                            {patient ? (
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        ...
                                        <InfoItem icon={Calendar}    label="Admitted"  value={patient.admission_date} />
